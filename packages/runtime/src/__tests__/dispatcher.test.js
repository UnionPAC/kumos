...
describe("A command dispatcher", () => {
  test("register and unregister handlers to specific commands", () => {
  ...
  test("can't register the same handler twice", () => {
    const dispatcher = new Dispatcher();
    const handler = vi.fn();
  ...
  test("unsubscribe multiple handlers", () => {
    const dispatcher = new Dispatcher();
  ...
  test("register and unregister handlers that run after each command", () => {
    const dispatcher = new Dispatcher();
    const handler = vi.fn();
